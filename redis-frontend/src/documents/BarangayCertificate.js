// documents/BarangayCertificate.js
import React from 'react';
import './DocumentStyles.css';


function BarangayCertificate({ resident, documentData, officials }) {
  ...
  return (
    <div className="document barangay-certificate">
      ...
      <div className="document-content">
        ...
        <p className="content-paragraph">
          ...
          {resident.sex === 'Male' ? ' Filipino' : ' Filipina'}, 
